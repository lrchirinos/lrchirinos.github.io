...
function MapModal({ onClose }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: '90%', maxWidth: '920px', height: '570px', background: '#0d1117',
        ...
        <div style={{
          ...
          <div style={{
            display: 'flex', alignItems: 'center', gap: '8px', color: '#3fb950',
...
function Navbar({ onLocationClick, onAboutClick, onHomeClick }) {
    ...
    return (
      <nav style={{
        ...
        <div style={{
          ...
          <a href="https://api.whatsapp.com/send?phone=51934654283"
  ...
  const mobileItems = [
    ...
    },
    {
      ...
      label: 'Contact Me',
      activeColor: '#25d366',
      action: () => window.open('https://api.whatsapp.com/send?phone=51934654283', '_blank'),
    },
  ];
...
function ProfilePhoto({ imgError, setImgError }) {
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{
        position: 'relative', marginBottom: '1.5rem', display: 'inline-block',
      ...
      {!imgError ? (
        <img src="/profile.png" alt="Luis Chirinos" onError={() => setImgError(true)}
          style={{
            width: hov ? '215px' : '200px', height: 'auto', borderRadius: 0, objectFit: 'contain',
        ...
        <div style={{
          width: '145px', height: '145px', borderRadius: '50%', background: '#0d1117',
          ...
          boxShadow: hov ? '0 0 30px rgba(63,185,80,0.5)' : 'none', transition: 'all 0.45s ease'
        }}>LC</div>
      )}
    </div>
  );
...
function TerminalLog({ lines, done }) {
  ...
  return (
    <div style={{
      marginTop: '30px', background: 'rgba(0,0,0,0.85)', padding: '18px 20px', borderRadius: '6px',
    ...
    <div ref={ref} style={{ marginBottom: '28px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginTop: '10px' }}>
        {skill.frameworks.map(fw => (
          <span key={fw} style={{
            background: 'rgba(48,54,61,0.55)', color: '#8b949e', padding: '2px 10px',
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 40px', boxSizing: 'border-box' }}>
        ...
        <div style={{ marginBottom: '70px' }}>
          ...
          <a href="https://www.unitru.edu.pe/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            <div style={{
              background: 'rgba(13,17,23,0.75)', border: '1px solid #30363d', borderRadius: '8px',
        ...
        <div>
          ...
          {CERTIFICATIONS.map(group => (
            <div key={group.issuer} style={{ marginBottom: '40px' }}>
              <p style={{
                color: group.color, fontFamily: 'monospace', fontSize: '0.82rem', letterSpacing: '2px',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {group.items.map(cert => (
                  <div key={cert.name} style={{
                    background: 'rgba(13,17,23,0.65)', border: '1px solid #30363d',
...
export default function App() {
  ...
  const particlesOptions = useMemo(() => ({
    ...
    interactivity: {
      events: { onClick: { enable: true, mode: "repulse" }, onHover: { enable: true, mode: "grab" } },
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '800px' }}>
        <div className="glass-panel" style={{
          padding: isMobile ? '24px' : '40px', borderRadius: '12px',
  ...
  return (
    <div style={{ position: 'relative', width: '100%', minHeight: '100vh', color: '#c9d1d9', overflowX: 'hidden', boxSizing: 'border-box' }}>
      ...
      <section style={{
        position: 'relative', zIndex: 10, height: '100vh', width: '100%',
        ...
        <h1 style={{
          fontSize: 'clamp(2.2rem,6vw,5rem)', margin: '0', lineHeight: '1.1', fontWeight: 900,
          letterSpacing: '-2px', color: '#ffffff', textShadow: '0 0 20px rgba(0,0,0,0.5)'
        }}>
          LUIS CHIRINOS
        </h1>
        <h2 style={{
          fontSize: 'clamp(0.9rem,3vw,1.8rem)', margin: '15px 0 0', fontWeight: '400', letterSpacing: '2px',
      ...
      {activeSection === 'experience' && !showTerminal && (
        <section ref={experienceRef} style={{
          ...
          <div style={{
            ...
            <h3 style={{
              borderBottom: '1px solid #30363d', paddingBottom: '20px',
            ...
            <div style={{
              ...
              {EXPERIENCE.map((exp, index) => (
                <div key={exp.id} className="project-card" onClick={() => setSelectedProject(exp)}
                  style={{
                    animation: `slideUp 0.6s ease forwards ${index * 0.2}s`, opacity: 0,
